...
file_path = "final_soil_data_with_spectral.csv"

if os.path.exists(file_path):
    df = pd.read_csv(file_path)
    st.success("✅ Dataset 'final_soil_data_with_spectral.csv' loaded successfully!")
else:
    st.error("❌ File 'final_soil_data_with_spectral.csv' not found. Please ensure the file is in the same directory.")
    st.stop()
